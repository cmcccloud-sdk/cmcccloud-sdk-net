/*
 * Copyright 2023 Cmcc Technologies Co.,Ltd.
 * 
...
namespace CmccCloud.SDK.Core.Auth
{
    ...
    {
        private const string AkEnvName = "CMCCCLOUD_SDK_AK";
        private const string SkEnvName = "CMCCCLOUD_SDK_SK";
        private const string ProjectIdEnvName = "CMCCCLOUD_SDK_PROJECT_ID";
        private const string DomainIdEnvName = "CMCCCLOUD_SDK_DOMAIN_ID";
        private const string SecurityTokenEnvName = "CMCCCLOUD_SDK_SECURITY_TOKEN";
